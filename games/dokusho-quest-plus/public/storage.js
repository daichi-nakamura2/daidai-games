...
const DQ_STORAGE_KEY = "dokusho-quest-plus-data-v1";
const DQ_THEME_KEY = "dokusho-quest-plus-theme";
const DQ_PLAYER_ID_KEY = "dokusho-quest-plus-player-id";
const DQ_CIRCLE_KEY = "dokusho-quest-plus-circle";
...
const DQ_LETTERS_KEY = "dokusho-quest-plus-letters";
